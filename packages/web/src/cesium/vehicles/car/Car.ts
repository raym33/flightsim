...
export class Car extends Vehicle {
  ...
  constructor(id: string, config: VehicleConfig) {
    ...
    // Realistic car physics for street driving
    const physicsConfig: PhysicsConfig = {
      vehicleMass: 1500,           // kg - typical sedan
      engineForce: 6000,           // N - moderate power for city driving
      brakeForce: 15000,           // N - strong brakes
      rollingResistance: 0.012,    // Asphalt rolling resistance
      airDragCoefficient: 0.35,    // Typical car drag coefficient
      maxSpeed: 180,               // km/h max speed
      wheelbase: 2.7,              // meters - typical sedan wheelbase
      maxSteeringAngle: Cesium.Math.toRadians(35) // More responsive steering
    };
